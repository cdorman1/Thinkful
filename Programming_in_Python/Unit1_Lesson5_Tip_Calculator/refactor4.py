...
parser.add_option("-t", "--tax", dest = "tax", help = "tax_percent", type="float")
parser.add_option("-p", "--tip", dest = "tip", help = "tip_percent", type = "float", default = 0.15)

(options, args) = parser.parse_args()

if not (options.meal and options.tax and options.tip):
    parser.error("""
...
meal_with_tax = options.meal + options.meal * options.tax
...
print "Tipping at a rate of %.2f%%, you should leave $%.2f for a tip." % (options.tip, tip_value)
